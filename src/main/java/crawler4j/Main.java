...
import crawler4j.fetcher.PageFetcher;
import crawler4j.robotstxt.RobotstxtConfig;
import crawler4j.robotstxt.RobotstxtServer;
...
public class Main {
    ...
    public static void main(String[] args){
        ...
        boolean flag = robotstxtServer.allows(taobaoUrl);
